            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {featureItems.map((feature, index) => (
                        ...
                        >
                            <div className="w-14 h-14 bg-gradient-to-br from-wheelx-yellow to-wheelx-yellow-dark rounded-2xl flex items-center justify-center text-wheelx-black mb-6 text-2xl group-hover:scale-110 transition-transform">
                                {feature.icon}
                            </div>
